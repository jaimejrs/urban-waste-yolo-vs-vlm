...
Para a inferência do Gemma, dois prompts solicitaram a presença de ao menos um saco e a localização individual de até 20 sacos, com caixas normalizadas em 0--1000 e resíduos avulsos excluídos. Um parser robusto isola o JSON por captura de chaves (\emph{brackets matching}) e o valida com \emph{jsonschema}; em falha de parsing ou timeout, a imagem seria conservadoramente rotulada como negativa, embora as 560 respostas tenham sido estruturadas com sucesso.
...
\caption{Exemplos qualitativos de localização no conjunto de teste. Caixas verdes indicam as anotações de referência (\emph{ground truth}); vermelhas, as previsões do YOLOv11m; azuis, as do Gemma 4 31B-QAT. O YOLO tende a alinhar-se às caixas de referência, enquanto o Gemma gera caixas em excesso e desalinhadas.}
