...
\markboth{Araújo Júnior and Caminha}
...
\author{Jaime Teixeira de Araújo Júnior$^{1}$, Carlos Caminha$^{1}$}

\institute{$^{1}$ Kunumi Lab - Universidade Federal do Ceará (UFC)\\
Fortaleza, CE, Brasil\\
...
\caption{Exemplos qualitativos de localização no conjunto de teste. Caixas verdes indicam as anotações de referência (\emph{ground truth}); vermelhas, as previsões do YOLOv11m; azuis, as do Gemma 4 31B-QAT. O YOLO tende a alinhar-se às caixas de referência, enquanto o Gemma gera caixas em excesso e desalinhadas. Imagens originais \copyright~2026 Google, utilizadas exclusivamente para avaliação acadêmica, com anonimização e sem redistribuição não autorizada, em conformidade com os termos de uso aplicáveis.}
