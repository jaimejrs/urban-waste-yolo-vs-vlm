...
\titlespacing*{\subsection}{0pt}{5pt plus 1pt minus 1pt}{2pt plus 0.5pt}
...
Para lidar com possíveis alucinações de formatação ou texto excedente gerado pelo VLM, implementou-se um mecanismo robusto de captura de chaves (\emph{brackets matching}) para isolar a estrutura JSON e posterior validação de esquema (\emph{jsonschema}). Caso o parsing falhasse por completo ou ocorresse timeout na requisição HTTP, a imagem seria conservadoramente rotulada como classe negativa (sem resíduos). No experimento de teste, contudo, todas as 560 inferências foram analisadas e estruturadas com sucesso pelo parser.
...
\item MIŠIĆ, J.; VAN EST, R.; KOOL, L. Good governance of public sector AI: a combined value framework for good order and a good society. \emph{AI and Ethics}, v. 5, p. 4875--4889, 2025. doi:\url{https://doi.org/10.1007/s43681-025-00751-3}.
